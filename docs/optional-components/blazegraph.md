...
* Navigate to the Blazegraph Admin panel http://isle-demo.localdomain:8084/blazegraph/#query
    * Replace `isle-demo.localdomain` with your real domain when using in a Local, Staging or Production
