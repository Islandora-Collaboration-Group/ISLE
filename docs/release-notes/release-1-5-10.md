# Release Notes - ISLE v.1.5.10, 2021-08
...
* `ImageMagick` upgraded to version `7.1.0-5`
* `Composer` upgraded to [commit / hash](c19391050a3d81f65e61049ebc30dbd4f5a99603) (v 1.10.22)
...
* `apt-get` dist-upgrades for dependencies security and package updates
* Apache `Tomcat` upgraded to `8.5.70`
* Github Actions [workflow](https://github.com/marketplace/actions/build-and-push-docker-images) updated
