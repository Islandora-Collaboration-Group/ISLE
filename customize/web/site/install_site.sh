...
/usr/local/bin/drush site-install -y --account-name=islandora_docker_admin --account-pass=islandoradockeradminpw2017 --account-mail=admin@islandora-docker.com --site-name="Islandora Docker"
